...
class SettingController extends Controller
{
    ...
    public function idoc_settings(Request $request){
    	$settings = Setting::all();
        $language = ['fr' => 'French', 'en' => 'English'];
    	return view('settings.idoc_settings', ['settings' => $settings, 'language' => $language]);
    }

    public function idoc_setting(Request $request){
    	$settings = Setting::all();
        $language = ['fr' => 'French', 'en' => 'English'];
    	return view('settings.idoc_setting', ['settings' => $settings, 'language' => $language]);
    }


    public function idoc_settings_store(Request $request){
    	...
    	return Redirect::route('idoc_settings.edit')->with('success', __("sentence.Settings edited Successfully") );
    }



    public function idoc_setting_stor(Request $request){
       ...
       return Redirect::route('admin.idoc_setting.edit')->with('success', __("sentence.Settings edited Successfully") );
   }
